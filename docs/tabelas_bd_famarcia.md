...
<h4 style="text-align: center; border: 1px solid #A9A9A9; padding: 10px; margin-bottom: -16px;">Entidade Medicamento</h4>
...
<h4 style="text-align: center; border: 1px solid #A9A9A9; padding: 10px; margin-bottom: -16px; width: 1041px">Entidade Categoria Medicamento</h4>
...
<h4 style="text-align: center; border: 1px solid #A9A9A9; padding: 10px; margin-bottom: -16px;">Entidade Fabricante Medicamento </h4>
...
<h4 style="text-align: center; border: 1px solid #A9A9A9; padding: 10px; margin-bottom: -16px;">Entidade Fornecedor Medicamento</h4>
...
<h4 style="text-align: center; border: 1px solid #A9A9A9; padding: 10px; margin-bottom: -16px; width: 1082px">Entidade Venda</h4>
...
| DescontoTotal       | Valor ou porcentagem de desconto aplicado                                                 | DECIMAL(10,2)| DEFAULT 0               |
| IdFuncionario       | Identificador do farmacêutico responsável pela venda                                      | MEDIUMINT(10)| FK, NOT NULL            |
| IdFilial            | Filial onde a venda foi realizada                                                         | MEDIUMINT(10)| FK, NOT NULL            |
| IdCliente           | Identificador do cliente                                                                  | MEDIUMINT(10)| FK, NOT NULL            |

<h4 style="text-align: center; border: 1px solid #A9A9A9; padding: 10px; margin-bottom: -16px;">Entidade Vendas Medicamento</h4>
...
| DescontoItem            | Valor ou porcentagem de desconto aplicado                                                 | DECIMAL(10,2)| DEFAULT 0               |
| QuantidadeItem          | Quantidade de unidades vendidas                                                           | INT          | NOT NULL                |
| ReceitaApresentada      | Indica se a receita médica foi apresentada (Sim/Não), aplicável apenas para medicamentos  | TINYINT(1)   | NOT NULL                |
| IdVenda                 | Identificador único da venda                                                              | MEDIUMINT(10)| FK, NOT NULL            |
| IdMedicamento           | Identificador do medicamento vendido                                                       | MEDIUMINT(10)| FK, NOT NULL            |
| IdPrescricao            | Identificador da prescrição                                                                | MEDIUMINT(10)| FK                      |

<h4 style="text-align: center; border: 1px solid #A9A9A9; padding: 10px; margin-bottom: -16px; width: 1107px">Entidade Vendas Serviço</h4>

| Atributo                | Descrição                                                                                 | Domínio      | Restrição do atributo   |
| ----------------------- | ----------------------------------------------------------------------------------------- | ------------ | ----------------------- |
| IdVendas_Serviço        | Identificador único da venda dos serviços                                                | MEDIUMINT(10)| PRIMARY KEY, AUTO INCREMENT, NOT NULL, UNIQUE |
| ValorServico            | Valor do serviço individual                                                                | DECIMAL(10,2)| NOT NULL                |
| DescontoItem            | Valor ou porcentagem de desconto aplicado                                                 | DECIMAL(10,2)| DEFAULT 0               |
| QuantidadeItem          | Quantidade de unidades vendidas                                                           | INT          | NOT NULL                |
| IdVenda                 | Identificador único da venda                                                              | MEDIUMINT(10)| FK, NOT NULL            |
| IdServico               | Identificador do serviço vendido                                                          | MEDIUMINT(10)| FK, NOT NULL            |

<h4 style="text-align: center; border: 1px solid #A9A9A9; padding: 10px; margin-bottom: -16px;">Entidade Serviço</h4>
...
<h4 style="text-align: center; border: 1px solid #A9A9A9; padding: 10px; margin-bottom: -16px;">Entidade Tipo de Serviço</h4>
...
<h4 style="text-align: center; border: 1px solid #A9A9A9; padding: 10px; margin-bottom: -16px; width: 1011px">Entidade Cliente</h4>


| Atributo        | Descrição                                        | Tipo de Dado | Restrição do Atributo            |
| ---------------- | ------------------------------------------------ | ------------ | -------------------------------- |
| IdCliente        | Identificador único do cliente                   | MEDIUMINT(10)| PRIMARY KEY, AUTO INCREMENT, NOT NULL, UNIQUE |
| Nome             | Nome completo do cliente                         | VARCHAR(100) | NOT NULL                         |
| Cpf              | Cadastro de Pessoa Física (CPF)                 | VARCHAR(11)  | NOT NULL, UNIQUE                 |
| Telefone         | Telefone de contato                             | VARCHAR(15)  | NOT NULL                         |
| Email            | E-mail do cliente                                | VARCHAR(100) | NOT NULL, UNIQUE                 |
| DataNascimento   | Data de nascimento do cliente                    | DATE         | NOT NULL                         |
| Endereco         | Endereço completo do cliente                     | VARCHAR(255) | NOT NULL                         |

<h4 style="text-align: center; border: 1px solid #A9A9A9; padding: 10px; margin-bottom: -16px; width: 1136px">Entidade Funcionário</h4>


| Atributo        | Descrição                                        | Tipo de Dado | Restrição do Atributo            |
| ---------------- | ------------------------------------------------ | ------------ | -------------------------------- |
| IdFuncionario    | Identificador único do funcionário               | MEDIUMINT(10)| PRIMARY KEY, AUTO INCREMENT, NOT NULL, UNIQUE |
| NomeFuncionario  | Nome completo do funcionário                     | VARCHAR(100) | NOT NULL                         |
| Cpf              | Cadastro de Pessoa Física (CPF)                 | VARCHAR(11)  | NOT NULL, UNIQUE                 |
| Telefone         | Telefone de contato                             | VARCHAR(15)  | NOT NULL                         |
| Email            | E-mail do funcionário                            | VARCHAR(100) | NOT NULL, UNIQUE                 |
| Cargo            | Cargo do funcionário                             | VARCHAR(50)  | NOT NULL                         |
| DataContratacao  | Data de contratação do funcionário               | DATE         | NOT NULL                         |
| IdFilial         | Identificador da filial onde o funcionário trabalha | MEDIUMINT(10)| FK, NOT NULL                     |

<h4 style="text-align: center; border: 1px solid #A9A9A9; padding: 10px; margin-bottom: -16px; width: 922px">Entidade Filial</h4>
...
| IdFilial         | Identificador único da filial                    | MEDIUMINT(10)| PRIMARY KEY, AUTO INCREMENT, NOT NULL, UNIQUE |
| NomeFilial       | Nome da filial                                   | VARCHAR(100) | NOT NULL                         |
| Endereco         | Endereço completo da filial                      | VARCHAR(255) | NOT NULL                         |
| Telefone         | Telefone da filial                              | VARCHAR(15)  | NOT NULL                         |
| Email            | E-mail da filial                                | VARCHAR(100) | NOT NULL, UNIQUE                 |

<h4 style="text-align: center; border: 1px solid #A9A9A9; padding: 10px; margin-bottom: -16px; width: 1135px">Entidade Prescrição</h4>


| Atributo        | Descrição                                        | Tipo de Dado | Restrição do Atributo            |
| ---------------- | ------------------------------------------------ | ------------ | -------------------------------- |
| IdPrescricao      | Identificador único da prescrição                | MEDIUMINT(10)| PRIMARY KEY, AUTO INCREMENT, NOT NULL, UNIQUE |
| DataPrescricao    | Data da prescrição                              | DATE         | NOT NULL                         |
| IdCliente         | Identificador do cliente                        | MEDIUMINT(10)| FK, NOT NULL                     |
| IdFuncionario     | Identificador do farmacêutico que fez a prescrição | MEDIUMINT(10)| FK, NOT NULL                     |

<h4 style="text-align: center; border: 1px solid #A9A9A9; padding: 10px; margin-bottom: -16px;">Entidade Prescricao Medicamento</h4>


| Atributo                | Descrição                                                                                 | Tipo de Dado | Restrição do Atributo            |
| ----------------------- | ----------------------------------------------------------------------------------------- | ------------ | -------------------------------- |
| IdPrescricao_Medicamento | Identificador único da relação entre prescrição e medicamento                            | MEDIUMINT(10)| PRIMARY KEY, AUTO INCREMENT, NOT NULL, UNIQUE |
| IdPrescricao            | Identificador da prescrição                                                                | MEDIUMINT(10)| FK, NOT NULL                     |
| IdMedicamento           | Identificador do medicamento prescrito                                                     | MEDIUMINT(10)| FK, NOT NULL                     |
| Dosagem                 | Dosagem recomendada do medicamento na prescrição                                           | VARCHAR(100) | NOT NULL                         |
| Frequencia              | Frequência de administração do medicamento                                                | VARCHAR(50)  | NOT NULL                         |



<h4 style="text-align: center; border: 1px solid #A9A9A9; padding: 10px; margin-bottom: -16px;">Entidade Cargo</h4>
...
<h4 style="text-align: center; border: 1px solid #A9A9A9; padding: 10px; margin-bottom: -16px;">Entidade Tipo de Receita</h4>
